  ...
  type
    TTabelaEstrangeira = class(TTabela)
      ...
      public
        ...
        constructor Create(PNome,PAlias,PId,PidEstrangeiro,PTipoJoin: string);
    end;
...
constructor TTabelaEstrangeira.Create(PNome,PAlias,PId, PidEstrangeiro, PTipoJoin: string);
begin
    FNome             := PNome;
    FAlias            := PAlias;
    FId               := PId;
