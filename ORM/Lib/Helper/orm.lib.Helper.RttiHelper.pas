...
begin
  Result := Name;
  if EhCampoTexto then
    Result := GetAtribute<TCampoTexto>.Nome;
  if EhCampoInteiro then
    Result := GetAtribute<TCampoInteiro>.Nome;
  if EhCampoData then
    Result := GetAtribute<TCampoData>.Nome;
  if EhCampoDataHora then
    Result := GetAtribute<TCampoDataHora>.Nome;
  if EhCampoExtended then
    Result := GetAtribute<TCampoExtended>.Nome;
  if EhCampoMonetario then
  ...
  if EhCampoFiltro then
    Result := GetAtribute<TCampoFiltro>.Nome;
  if EhSomatorio then
    Result := GetAtribute<TSomatorio>.Nome;
  if EhMedia then
    Result := GetAtribute<TMedia>.Nome;
  if EhMinimo then
    Result := GetAtribute<TMinimo>.Nome;
  if EhMaximo then
    Result := GetAtribute<TMaximo>.Nome;
...
begin
   ...
   begin
     ...
     if prop.GetAtribute<TCampoInteiro>.Nome = aPropName then
        Exit(prop);
     if prop.GetAtribute<TCampoData>.Nome = aPropName then
       Exit(prop);
     if prop.GetAtribute<TCampoDataHora>.Nome = aPropName then
       Exit(prop);
     if prop.GetAtribute<TCampoExtended>.Nome = aPropName then
        Exit(prop);
     ...
     if prop.GetAtribute<TCampoEstrangeiro>.Nome = aPropName then
        Exit(prop);
     if prop.GetAtribute<TSomatorio>.Nome = aPropName then
       Exit(prop);
     if prop.GetAtribute<TMedia>.Nome = aPropName then
        Exit(prop);
     if prop.GetAtribute<TMinimo>.Nome = aPropName then
        Exit(prop);
     if prop.GetAtribute<TMaximo>.Nome = aPropName then
        Exit(prop);
   end;
end;
